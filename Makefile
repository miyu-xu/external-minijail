...
# filesystems.
#
# For example, on Chrome OS executable filesystems are mounted read-only. Noexec
# filesystems are allowed to be mounted read-write. If a configuration file were
# allowed to reside in a noexec filesystem, an attacker would be able to
